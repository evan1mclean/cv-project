...
//React-to-print was struggling with displaying functional components so I converted back to a class component
  ...
  render() {
    ...
    const profilePhoto =
      personalDetails.photo === "" ? (
        ...
        <img src={personalDetails.photo} alt="Your upload" />
      );
    ...
    return (
      <div className="cv-preview">
        <div className="personal-details">
          ...
          <div className="profile-picture">{profilePhoto}</div>
        </div>
